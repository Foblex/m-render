import {
  ...
  Component, DestroyRef, HostListener, inject, Injector, OnInit,
} from '@angular/core';
...
export class FMarkdownFooterComponent implements OnInit {
  ...
  private readonly _provider = inject(F_MARKDOWN_FOOTER_NAVIGATION);
