...
export class CalculateTableOfContentDataHandler implements IExecution<CalculateTableOfContentDataRequest, void> {
  ...
  private _getNavigationSelectors(fMarkdownPage: HTMLElement, tocRange?: { start: number, end: number }): HTMLElement[] {
