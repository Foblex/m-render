...
import { FStateService } from '@f-common';
import { Router } from '@angular/router';
import { INavigationGroup, INavigationItem } from '@f-common';
import { FEnvironmentService } from '../../services';
import { FPreviewBase } from './f-preview-base';
import { FPreviewGroupService } from '../f-preview-group';
...
export class FPreviewComponent extends FPreviewBase implements OnInit, OnDestroy {
  ...
  private _fEnvironment = inject(FEnvironmentService);
