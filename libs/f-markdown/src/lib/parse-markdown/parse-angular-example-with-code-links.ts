...
import { EParsedContainerType, INgComponentParsedData, IParsedContainerData } from "../domain";
...
export class ParseAngularExampleWithCodeLinks {
  ...
  private _parseNgComponent(token: IMarkdownItToken): INgComponentParsedData | null {
