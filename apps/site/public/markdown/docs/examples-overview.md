...
6. Finish with full code capabilities (`Code Features Playground`).

## Included examples

* [TOC Disabled](example-hide-toc): hide right-side table of contents.
* [TOC Disabled + Wide Content](example-hide-toc-wide-content): hide TOC and expand content width.
* [SEO Overrides](example-seo-overrides): override title, description, Open Graph and Twitter metadata.
* [Origin Link](example-origin-link): render source attribution block from frontmatter.
...
7. Open `Code Features Playground` and verify focus/blur markers and fullscreen behavior.
